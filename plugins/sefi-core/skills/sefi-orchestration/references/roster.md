...
| `research-analyst.md` | low | memory-protocol | read-only; digest contract | cheap |
| `product-manager.md` | mid | loop-engineering, premortem (optional) | fixed heading skeleton; grep-countable steps | mid |
| `ui-ux-designer.md` | mid | frontend-design | four verbs (build/audit/redesign/study); direction-first; never pixel-clones | mid |
...
| `knowledge-manager.md` | low | memory-protocol | append-only; single writer for `memory/` | cheap |
