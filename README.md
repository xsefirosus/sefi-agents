...
(forensic pre-execution failure analysis, invoked by name), `focus`, `run-sefi-benchmark`
(blinded paired A/B benchmark of the chain versus one strong model, invoked by name).
